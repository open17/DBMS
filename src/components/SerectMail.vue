<template>
  <dialog id="my_modal_1" class="modal">
    <div class="modal-box flex justify-center items-center py-40 bg-base-200">
      <div class="card">
        <div
        ...
        >
          ...
          >
            <p
              class="text-xl sm:text-2xl font-semibold text-gray-500 font-serif"
            >
              Congratulation!
            </p>
            <p class="px-10 text-[10px] sm:text-[12px] text-gray-700">
              You have receive a serect code which can use at checkout and get
              money off all year round.
            </p>
